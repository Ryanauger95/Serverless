...
(function (FUND_STATE) {
    ...
    FUND_STATE[FUND_STATE["TRANSFER_PENDING"] = 2] = "TRANSFER_PENDING";
    FUND_STATE[FUND_STATE["FUNDED"] = 3] = "FUNDED";
...
var Txn = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Txn, "relationMappings", {
        get: function () {
            ...
            return {
                ...
                wallet: {
                    relation: mysql_1.Model.ManyToManyRelation,
    ...
    Txn.markFunded = function () {
        console.log("Funded");
    };
    Txn.markFundsIssued = function (txnId) {
        return this.query()
            .findById(txnId)
            .patch({ fund_state: FUND_STATE.ISSUE_PENDING });
    };
    return Txn;
}(mysql_1.Model));
exports.Txn = Txn;
...
function save(amount, reserve, description, payer, collector, originator, period) {
    var _this = this;
    return mysql_1.knex.transaction(function (trx) { return __awaiter(_this, void 0, void 0, function () {
        var fee_id, holding_id, txn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fee(trx, amount)];
                case 1:
                    fee_id = (_a.sent())[0];
                    console.log("fee id: ", fee_id);
                    return [4 /*yield*/, holdingPeriod(trx, period)];
                case 2:
                    holding_id = (_a.sent())[0];
                    console.log("holding id: ", holding_id.insertId);
                    return [4 /*yield*/, trx("txn").insert({
                            amount: amount,
                            reserve: reserve,
...
function holdingPeriod(driver, period) {
    var due_date = (Date.now() / 1000 + 60 * 60 * 24 * period) | 0;
