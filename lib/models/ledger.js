...
(function (LEDGER_TYPE) {
    ...
    LEDGER_TYPE[LEDGER_TYPE["TRANSFER"] = 1] = "TRANSFER";
    LEDGER_TYPE[LEDGER_TYPE["REDEEM"] = 2] = "REDEEM";
...
var Ledger = /** @class */ (function (_super) {
    ...
    Ledger.insertLedgerAndUpdateBalanceTrx = function (toHandle, fromHandle, reference, type, amount, state, txnId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        trx = _a.sent();
                        return [4 /*yield*/, this.insertLedgerAndUpdateBalance(trx, toHandle, fromHandle, reference, type, amount, state, txnId)];
                    case 2:
                        _a.sent();
                        trx.commit();
                        return [3 /*break*/, 4];
    ...
    Ledger.insertLedgerAndUpdateBalance = function (trx, toHandle, fromHandle, reference, type, amount, state, txnId) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        switch (_a) {
                            ...
                            case LEDGER_TYPE.TRANSFER: return [3 /*break*/, 6];
                        }
                        return [3 /*break*/, 9];
                    case 2:
    ...
    // NOTE: All ledger updates must run through this function
    // so that balance updates are properly made
    Ledger.updateLedgerAndBalance = function (id, ledgerUpdate) {
        var _this = this;
        var toHandle = ledgerUpdate.toHandle, fromHandle = ledgerUpdate.fromHandle, reference = ledgerUpdate.reference, type = ledgerUpdate.type, amount = ledgerUpdate.amount, state = ledgerUpdate.state;
        return mysql_1.transaction(mysql_1.knex, function (trx) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        // Update the ledger
                        return [4 /*yield*/, this.updateEntryState(id, ledgerUpdate, trx)];
                    case 2:
                        // State Change validated.
                        // Update the ledger
                        _b.sent();
                        ...
                        switch (_a) {
                            ...
                            case LEDGER_TYPE.TRANSFER: return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 10];
                    case 3:
                        patchJSON = {
    ...
    // the state
    Ledger.updateEntryState = function (id, _a, trx) {
        var toHandle = _a.toHandle, fromHandle = _a.fromHandle, reference = _a.reference, type = _a.type, amount = _a.amount, state = _a.state;
