...
var Ledger = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        // Update the ledger
                        return [4 /*yield*/, this.updateEntryState(id, toHandle, fromHandle, reference, type, amount, state, trx)];
                    case 2:
                        // State Change validated.
                        // Update the ledger
                        _b.sent();
    ...
    // the state
    Ledger.updateEntryState = function (id, toHandle, fromHandle, reference, type, amount, state, trx) {
