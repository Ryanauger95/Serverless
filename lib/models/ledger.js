...
var Ledger = /** @class */ (function (_super) {
    ...
    Ledger.insertLedgerAndUpdateBalance = function (ledgerInsert) {
        var _this = this;
        var toHandle = ledgerInsert.toHandle, fromHandle = ledgerInsert.fromHandle, reference = ledgerInsert.reference, type = ledgerInsert.type, amount = ledgerInsert.amount, state = ledgerInsert.state;
        return mysql_1.transaction(mysql_1.knex, function (trx) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Ledger.query().insert(ledgerInsert)];
                    case 1:
                        _b.sent();
