import { BaseModel, transaction, knex } from "../handlers/mysql";
...
enum LEDGER_TYPE {
  UNKNOWN = "UNKNOWN",
  ISSUE = "ISSUE",
  TRANSFER_TO_FBO = "TRANSFER_TO_FBO",
  TRANSFER_FROM_FBO = "TRANSFER_FROM_FBO",
  TRANSFER_TO_FEE = "TRANSFER_TO_FEE",
